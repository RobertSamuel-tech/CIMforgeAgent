# CIMForge — Build Guide

## Overview

This document describes how to build the CIMForge project, both manually and through the automated CI/CD pipeline. The project is a monorepo managed with Lerna and Yarn, containing React-based Splunk UI components.
