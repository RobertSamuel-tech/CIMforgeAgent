# CIMforgeAgent UI (Splunk App Frontend)

This package provides the main React UI for CIMforgeAgent, enabling wizard-driven onboarding of new data sources with AI-powered field extraction, CIM mapping, PII detection, and agentic config generation.
